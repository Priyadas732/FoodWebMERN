  ...
  useEffect(() => {
      ...
      if(paymentStatus === 'paid' && sessionId){
          ...
          .catch(err => {
             ...
             setError( 'Payment confirmation failed. Pleasect support.');
          })
...
//SUBMIT FUNCTION
  const handleSubmit = async e => {
        ...
        subtotal,
        tax,
        shipping: 0, // ✅ Add this line chtgpt
    ...
    try{
      if(formData.paymentMethod === 'cod'){
        ...
        console.error('Orders submission Error:', err);
                ...
                < div className = "bg-[#4b3b3b]/80 p-6 rounded-3xl space-y-6" >
                    ...
                    <div className=' bg-[#4b3b3b]/80 p-6 rounded-3xl space-y-6'>
                          ...
                          <div className=' space-y-4 mb-6'>
                               <h3 className=' text-lg font-semibold'>Your Order Items</h3> 

                               {cartItems.map(({ _id,item, quantity }) => (
                                  <div key={_id} className=' flex justify-center items-center bg-[#3a2b2b] p-3 rounded-lg'>
                          ...
                          {error && <p className=' bg-red-400 mt-2'>{error}</p>}
