        ...
        <div className=' max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 md:gap-12'>
          {features.map((f, i) => {
            ...
            return (
              ...
              >
                <div
                  className='absolute -insett-1 bg-gradient-to-br from-amber-600/30 rounded-3xl
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  >
                    <motion.div
                      className=' absolute insett-0 rounded-xl'
                      animate={{
                        background: [
                    ...
                    />
                    <div className=' absolute inset-0 rounded-xl shadow-lg shadow-amberr-900/20' />
                ...
                <motion.div
                  className=' absolute inset-x-4 bottom-0 bg-amber-900/30 blur-xl rounded-full'
                  animate={{
                  ...
                  className=' relative h-full bg-[#3c2a21]/90 backdrop-blur-lg rounded-3xl overflow-hidden
                    ...
                    hover:shadow-2xl hover:shadow-amber-500/20'>
                     <div className=' relative h-64 sm:h-72 md:h-96 overflow-hidden'>
                          ...
                          initial={{ scale: 1 }} whileInView={{ scale:1.1 }} transition={{ duration: 0.5}}/>
                     </div>
