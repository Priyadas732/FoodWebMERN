                 ...
                 <div className=' max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-12 relative z-10'>
                     ...
                     <div className=' flex-1 space-y-8 relative md:pr-8 lg:pr-19 text-center md:text-left'>
                          ...
                          <form onSubmit={handleSearch} className=' relative max-w-2xl mx-auto md:mx-0 group'>
                              <div className='relative flex items-center bg-amber-900/30 rounded-xl border-2 border-amber-500/30
                               shadow-2xl hover:bg-amber-400/50 transition-all duration-300'>
                                  ...
                                  className=' w-full  py-4 pr-6 bg-transparent outline-none placeholder:text-amber-200/70 text-lg 
                          ...
                          <div className=' flex flex-wrap gap-4 justify-center md:justify-start mt-6'>
                                 <button className=' group flex items-center gap-3 bg-amber-800/30 hover:bg-amber-800/50 px-6 py-3 rounded-xl
                                  transition-all duration-300 border-2 border-amber-700/50 hover:border-amber-400 backdrop-blur-sm'>
                  ...
                  <div className=' flex-1 relative group mt-8 md:mt-0 min-h-[300px] sm:min-h-[400px]'>
                          ...
                          shadow-2xl z-20 w-[250px] xs:w-[300px] sm:w-[350px] h-[250px] xs:h-[300px] sm:h-[350px] mx-auto'>
                             ...
                             <div className=' absolute inset-0 rounded-full bg-gradient-to-b from-transparent to-amber-900/40 mix-blend-medium'/>
                          </div>
                          {/* ORBITAL IMAGES */}
        ...
        {showVideo && (
             <div className=' fixed inset-0 flex items-center justify-center z-50 bg-black/90 backdrop-blur-lg p-4 '>
                 ...
                 <div className=' w-full max-w-4xl mx-auto'>
                    <video 
                    controols autoPlay className=' w-full aspect-video object-contain rounded-lg
                     shadow-2xl'>
