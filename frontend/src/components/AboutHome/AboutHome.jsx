              ...
              xl:gap-16 relative'>
                 <div className=' w-full order-1 lg:order-2 space-y-8 sm:space-y-12 relative'>
                     <div className=' space-y-4 sm:space-y-8 px-4 sm:px-0 '>
                        <h2 className=' text-3xl sm:text-4xl md:text-5xl x:text-6xl font-bold leading-tight'>
                        ...
                        <p className=' text-base sm:text-lg md:text-xl opacity-90 leading-relaxed max-w-3xl font-sorif
                     ...
                     <div className=' flex flex-wrap gap-4 items-center mt-6 sm:mt--8 px-4 sm:px-0'>
                         <Link to='/about' className='px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-amber-500 to-amber-600
                 ...
                 <div className=' w-full order-2 lg:order-1 md:max-w-md lg:max-w-none lg:w-7/12 mt-12 mb-10 lg:mb-0 relative
                  group transform hover:scale-[1.01] transition-all duration-300'>
                          <div className='realtive rounded-[4rem] overflow-hidden border-4 border-amber-900/30 hover:border-amber-600/40 transition duration-500 shadow-2xl shadow-black/50'>
                              ...
                              <img src={AboutImage} alt="Restaurant" className=' w-full h-auto object-cover aspect-[3/4] transform-rotate-1
                               ...
                               <div className=' absolute -bottom-12 left-1/2 -translate-x-1/2 w-4/5 h-16 bg-amber-900/10 blur-3xl z-0'/>
