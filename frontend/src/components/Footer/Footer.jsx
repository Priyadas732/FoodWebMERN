...
const Footer = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert(`Thank you for subscribing! You will receive updates to your inbox at ${email}`);
    setEmail('');
  }
  return (
         ...
         <div className=' max-w-7xl mx-auto relative z-10'>
             <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-12'>
                 ...
                 <div className=' space-y-6'>
                      ...
                      <p className=' text-amber-200/90 text-sm font-sacramento italic'>
                          Where gourmet meets your doorstep <br/>
                          Homemade delights, brought to your door.
                      </p>  
                           ...
                           onChange={e => setEmail(e.target.value)}
                            className='w-full px-4 py-2.5 rounded-lg bg-amber-50/5 border-2 border-amber-400/30 focus:outline-none
                             ...
                             <button type='submit' className=' absolute right-1 top-1 bg-gradient-to-br from-amber-300 via-orange-500 to-amber-600 text-white px-4 py-2 rounded-full
                              ...
                              <span className=' font-bold text-sm tracking-wide transition-transform duration-300 group-hover:-translate-x-1'>Join Now</span>
             ...
             <div className=' border-t border-amber-800 pt-8 mt-8 text-center'>
              <p className=' text-amber-400 text-lg mb-2 font-playfair'>
                  &copy; 2025 Foodie-Pee. All Rights Reserved.
              </p>
