        ...
        <div className=' max-w-7xl mx-auto'>
             <div className=' text-center mb-14'>
                 <h1 className=' text-5xl font-bold mb-4 transform transition-all bg-gradient-to-r from-amber-400
                  text-red-500 bg-clip-text text-transparent font-[Playfair_Display] italic'>
                 ...
                 <p className=' text-lg text-gray-300 max-w-3xl mx-auto tracking-wide leading-relaxed'>
                          Savor the extraordinary with our exclusive special offers, crafted to delight your taste buds and elevate your dining experience.
                 </p>
             </div>
             {/* PRODUCT CARD */}
                            ...
                            hover:shadow-red-900/40 border-2 border-transparent hover:border-amber-500/20 before:absolute
                             before:inset-0 hover:before:opacity-20'>
                                    ...
                                    <div className=' absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black/90'/>
                                       <div className=' absolute bottom-4 left-4 right-4 flex justify-between items-center bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full'>
                                          <span className=' flex items-center gap-2 text-amber-400'>
                                                    <FaStar className=' text-xl drop-shadow-[0_2px_2px_gba(0,0,0,0.8)]'/>
                                ...
                                <div className=' p-6 relative z-10'>
                                       ...
                                       <p className=' text-gray-300 mb-5 text-sm leading-relaxeed tracking-wide'>
                                                    {item.description}
                                       </p>
             ...
             <div className=' mt-12 flex justify-center'>
                  <button onClick={() => setShowAll(!showAll)} className=' flex items-center bg-gradient-to-br from-amber-700 to-amber-700
                   text-white px-8 py-4 rounded-2xl font-bold text-lg uppercase tracking-winter hover:gap-4 hover:scale-105 
                    hover:shadow-xl hover:shadow-amber-500/20 transition-all duration-300 group border-2 border-amber-400/30 relative
                     overflow-hidden'>
                        <div className=' absolute inset-0 bg-gradient-to-br fill-amber-500/20 via-transparent to-amber-500/10
