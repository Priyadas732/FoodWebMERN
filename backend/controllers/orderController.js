...
export const getAllOrders = async (req, res) => {
     try {
         ...
         const formatted = raw.map(o => ({
             ...
             email: o.email,
             phone: o.phone,
             address: o.address?? o.shippingAdress?.address?? '',
             city: o.city?? o.shippingAdress?.city ??'',
             zipCode: o.zipCode ?? o.shippingAdress?.zipCode ?? '',
...
// UPDATE ORDER WITHOUT TOKEN FOE ADMIN
